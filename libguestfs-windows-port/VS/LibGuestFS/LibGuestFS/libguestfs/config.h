...
/* #undef HAVE_FUSE_OPT_ADD_OPT_ESCAPED */
...
#define HAVE_LZMA_INDEX_STREAM_FLAGS 1

/* Define to 1 if you have the `lzma_index_stream_padding' function. */
#define HAVE_LZMA_INDEX_STREAM_PADDING 1
...
#define PACKAGE_STRING "libguestfs 1.28.5"
...
/* Define to 1 to run the daemon under valgrind. */
/* #undef VALGRIND_DAEMON */
...
#define WRESTOOL "/usr/bin/wrestool"
